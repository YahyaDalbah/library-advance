...
public class StudentTableController {
    ...
    //this was added by abdellatif to navigate to Add new student

    @FXML
    private void handleAddNewStudent(MouseEvent event) {
        loadPopupScene(event, "Add-new-student-popup.fxml", "Add New Student");
    }
